"""
Django settings for newop project.
...
SECRET_KEY = 'django-insecure-_*dm68f0=h8z3jv0+bjwdmphh60zy^&*5o^12zh!b&&15$n@=)'
...
WSGI_APPLICATION = 'newop.wsgi.application'
